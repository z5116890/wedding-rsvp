...
export type UserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: number, type: string, firstName: string, lastName: string, code: string, rsvp: boolean | null, numPlusOnes: number, dietaryRestrictions: string | null, welcomeMessage: string | null, stayingAt: { __typename?: 'AccommodationGuestStayDetails', name: string, address: string, checkInDate: string, checkOutDate: string } | null }, userPlusOnes: Array<{ __typename?: 'User', id: number, type: string, firstName: string, lastName: string, code: string, rsvp: boolean | null, numPlusOnes: number, dietaryRestrictions: string | null, welcomeMessage: string | null }> };
...
export type ListUsersQuery = { __typename?: 'Query', users: { __typename?: 'UserList', pages: number, totalItems: number, items: Array<{ __typename?: 'User', id: number, type: string, firstName: string, lastName: string, code: string, rsvp: boolean | null, numPlusOnes: number, dietaryRestrictions: string | null, welcomeMessage: string | null, plusOneOf: number | null } | null> | null } | null };
